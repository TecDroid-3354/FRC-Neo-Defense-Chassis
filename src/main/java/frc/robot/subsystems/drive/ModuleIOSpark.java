...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    absoluteEncoderConfig.MagnetSensor.SensorDirection =
        (switch (module) {
              case 0 -> frontLeftAbsoluteInverted;
              case 1 -> frontRightAbsoluteInverted;
              case 2 -> backLeftAbsoluteInverted;
              case 3 -> backRightAbsoluteInverted;
              default -> false;
            })
    ...
    tryUntilOk(
        turnSpark,
        5,
        () -> turnEncoder.setPosition(absoluteEncoder.getPosition().getValue().in(Units.Radians)));
